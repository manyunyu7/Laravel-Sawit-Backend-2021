        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Harga TBS</h3>
                    <p class="text-subtitle text-muted">Input Harga Baru</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('material/manage') }}">Harga</a></li>
...
@section('page-content')
    ...
    <form action="{{ url('price/store') }}" enctype="multipart/form-data" method="post">
        @csrf
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Input Harga Jual Tandan Buah Segar</h4>
                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" required class="form-control" name="price" id=""
                                    aria-describedby="helpId" placeholder="Harga Sawit per Kilogram">
                                <small id="helpId" class="form-text text-muted">Harga Sawit</small>
                            </div>
                            <div class="form-group">
