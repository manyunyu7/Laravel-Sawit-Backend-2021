        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Manage Armada</h3>
                    <p class="text-subtitle text-muted">Manage Armada Milik Perusahaan</p>
                </div>
                <div class="col-12 col-md-6 order-md-2 order-first">
                    <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="#">Armada Perusahaan</a></li>
                                    ...
                                    <table class="table table-striped dataTable-table" id="table_data">
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-sortable="">Nama Armada</th>
                                                <th data-sortable="">Nomor Polisi</th>
                                                <th data-sortable="">Bahan Bakar</th>
                                        ...
                                        <tbody>
                                            @forelse ($datas as $data)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{url('armada/'.$data->id.'/edit')}}">
